...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "z-[100] max-h-96 min-w-32 overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md bg-background",
        position === "popper" &&
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          position === "popper" &&
            "max-h-[var(--radix-select-content-available-height)] w-full",
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex h-9 w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm leading-none outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
